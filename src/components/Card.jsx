  ...
  return (
    <div>
      ...
      >
        ...
        <div className='h-56 px-5 pt-5 font-bold tracking-tight'>
          <a href='#'>
            <h2 className='mb-2  line-clamp-2 text-2xl font-bold tracking-tight dark:text-white'>
              {blog?.blogData?.title}
            </h2>
          </a>
          <p className='mb-3 line-clamp-2 font-normal text-gray-300  dark:text-gray-400'>
          {typeof blog?.blogData?.content === 'string' 
