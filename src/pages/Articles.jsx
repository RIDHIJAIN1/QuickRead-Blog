  ...
  useEffect(() => {
    const fetchBlogs = async () => {
      try {
        ...
        const q = query(blogRef, orderBy("timestamp", "desc"), limit());
    ...
    <div className='mx-auto max-w-7xl'>
      ...
      {!loading ? (
        <InfiniteScroll
          ...
          next={fetchMoreBlogs}
          hasMore={hasMore}
          className='mx-auto mt-12 grid w-[95%] grid-cols-1 gap-5  sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3'
          loader={
            <div className='loader flex h-24 w-24  rounded-full border-8 border-t-8 border-gray-200 ease-linear'></div>
          }
        >
