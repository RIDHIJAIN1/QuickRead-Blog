...
const Home = () => {
  ...
  return (
    <div className='mx-auto max-w-7xl transition-all duration-300 ease-in-out'>
      ...
      {/* Articles */}
      <div>
        <h1 className='my-12 pl-2 text-3xl font-extrabold md:pl-9 md:text-4xl mx-auto justify-center text-center'>
          <Balancer>Latest articles on the web</Balancer>
        </h1>
        <div className=' mx-auto grid w-[80%] grid-cols-1 gap-5 md:w-[100%] md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3'>
          {loading ? (
